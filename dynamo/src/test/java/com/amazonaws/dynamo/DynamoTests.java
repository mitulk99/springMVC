...
public class DynamoTests {
  ...
  public static void testCreateTable() {
    assertEquals(DynamoTableRequest.createTable("Store", "pincode", "store_id"), "Store");
  }
...
//        + "\"Offices\": [ \"Tokyo\", \"Los Angeles\", \"Sydney\"" + "            ]" + "        }" + "    }";
    ...
    Map<String, Object> dataMap = new HashMap<>();
    dataMap.put("name", "mitul");
    dataMap.put("year", 1999);
   // dataMap.put("vendor", vendorDocument);

    assertNotNull(DynamoPostRequest.postData("395009", "s_1", dataMap));
